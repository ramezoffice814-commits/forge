// POST /functions/v1/start-mission
// Thin wrapper around forge_start_mission — see accept-mission/index.ts
// for the shared shape every one of these five functions follows.
...
const FUNCTION_NAME = "start-mission";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { data, error } = await client.rpc("forge_start_mission", {
